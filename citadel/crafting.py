...
def create_crafting_stations(interaction, station_name=None):
    ...
    # Shields
    buckler = Shield("Buckler", defense_modifier=round(1 + base / 10), value=30 + round(base ** 2) * 1,
                     zone_level=zone_level)
    small_shield = Shield("Small Shield", defense_modifier=round(2 + base / 5), value=round(40 + (base ** 2) * 1.5),
                          zone_level=zone_level)
    large_shield = Shield("Large Shield", defense_modifier=round(3 + base / 3), value=50 + round(base ** 2) * 2,
                          zone_level=zone_level)

    # Armors
    brigandine_armor = Armor("Brigandine Armor", defense_modifier=round(4 + base / 2), armor_type=ArmorType.CHEST,
                             value=80 + round(base ** 2) * 5, zone_level=zone_level)
    brigandine_boots = Armor("Brigandine Boots", defense_modifier=round(3 + base / 4), armor_type=ArmorType.BOOTS,
                             value=50 + round(base ** 2) * 3, zone_level=zone_level)
    ...
    leather_armor = Armor("Leather Armor", defense_modifier=round(3 + base / 3), armor_type=ArmorType.CHEST,
                          value=60 + round(base ** 2) * 4, zone_level=zone_level)
    leather_boots = Armor("Leather Boots", defense_modifier=round(2 + base / 5), armor_type=ArmorType.BOOTS,
                          value=round(40 + (base ** 2) * 2.5), zone_level=zone_level)
    ...
    padded_armor = Armor("Padded Armor", defense_modifier=round(2 + base / 4), armor_type=ArmorType.CHEST,
                         value=40 + round(base ** 2) * 4, zone_level=zone_level)
    padded_boots = Armor("Padded Boots", defense_modifier=round(1 + base / 6), armor_type=ArmorType.BOOTS,
                         value=20 + round(base ** 2) * 2, zone_level=zone_level)
