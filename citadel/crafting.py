...
long_sword = Weapon("Long Sword", "Sword", attack_modifier=1, special_attack= 2, value=10)
champion_sword = Weapon("Champion Sword", "Sword", attack_modifier=1, special_attack= 3, value=10)
voltaic_sword = Weapon("Voltaic Sword", "Sword", attack_modifier=1, special_attack= 4, value=10)
short_spear = Weapon("Short Spear", "Spear", attack_modifier=1, special_attack= 1, value=10)
long_spear = Weapon("Long Spear", "Spear", attack_modifier=1, special_attack= 2, value=10)
champion_spear = Weapon("Champion Spear", "Spear", attack_modifier=1, special_attack= 3, value=10)
club = Weapon("Club", "Hammer", attack_modifier=1, special_attack= 1, value=10)
hammer = Weapon("Hammer", "Hammer", attack_modifier=1, special_attack= 2, value=10)
war_hammer = Weapon("War Hammer", "Hammer", attack_modifier=1, special_attack= 3, value=10)
short_bow = Weapon("Short Bow", "Bow", attack_modifier=1, special_attack= 1, value=10)
long_bow = Weapon("Long Bow", "Bow", attack_modifier=1, special_attack= 2, value=10)
champion_bow = Weapon("Champion Bow", "Bow", attack_modifier=1, special_attack= 3, value=10)
